    ...
    var body: some View {
        Map(scope: pineMapScope)
            ...
            .sheet(isPresented: $showSheet) {
                ...
                //     }
                // }
                .presentationDetents([.height(70), PresentationDetent.fraction(0.5), .large])
                .presentationBackgroundInteraction(.enabled(upThrough: PresentationDetent.fraction(0.5)))
